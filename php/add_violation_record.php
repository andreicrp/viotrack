...
try {
    ...
    // Prepare insert statement with type, proof, accuracy
    $insertQuery = "INSERT INTO record (status, vid, date, sid, aid, lat, lng, type, proof, accuracy) VALUES ('Pending', ?, ?, ?, ?, ?, ?, NULL, NULL, 0)";
